...
export default function Hero() {
  return (
    <section className="w-full bg-white px-1 pt-1 sm:px-2 sm:pt-2">
      <div className="relative overflow-hidden bg-white shadow-lg lg:hidden">
        <img
          src="/images/hero.png"
        ...
        <div className="relative flex min-h-[76vh] items-center justify-center px-6 py-16 text-center">
      ...
      <div className="hidden min-h-135 overflow-hidden bg-white shadow-lg lg:grid lg:grid-cols-[1.38fr_1fr]">
